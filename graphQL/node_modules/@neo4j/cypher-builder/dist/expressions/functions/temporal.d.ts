...
export declare namespace cypherDatetime {
    ...
    var realtime: (timezone?: Expr | undefined) => CypherFunction;
    var statement: (timezone?: Expr | undefined) => CypherFunction;
    var transaction: (timezone?: Expr | undefined) => CypherFunction;
    var truncate: (unit: TemporalUnit, temporalInstantValue: Expr, mapOfComponentsTimezone?: Expr | undefined) => CypherFunction;
}
/**

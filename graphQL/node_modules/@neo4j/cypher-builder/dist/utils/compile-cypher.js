 ...
 */
function compileCypher(element, env, { prefix = "", suffix = "" } = {}) {
    if (!(0, is_cypher_compilable_1.isCypherCompilable)(element))
        throw new Error("Invalid element, missing `getCypher` method");
    if (!env)
        throw new Error("Missing env when compiling Cypher");

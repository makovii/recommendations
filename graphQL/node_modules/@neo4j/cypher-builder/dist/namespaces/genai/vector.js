...
exports.encodeBatch = exports.encode = void 0;
...
function encode(resource, provider, configuration) {
    return new CypherFunctions_1.CypherFunction("genai.vector.encode", [
        resource,
        (0, normalize_variable_1.normalizeVariable)(provider),
        (0, normalize_variable_1.normalizeMap)(configuration),
    ]);
}
...
function encodeBatch(resources, provider, configuration) {
    return new CypherProcedure_1.CypherProcedure("genai.vector.encodeBatch", [
        resources,
        (0, normalize_variable_1.normalizeVariable)(provider),
        (0, normalize_variable_1.normalizeMap)(configuration),
    ]);

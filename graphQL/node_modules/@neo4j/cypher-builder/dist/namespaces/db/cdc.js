...
exports.query = exports.earliest = exports.current = void 0;
 ...
 */
function current() {
    return new CypherProcedure_1.CypherProcedure("db.cdc.current");
}
 ...
 */
function earliest() {
    return new CypherProcedure_1.CypherProcedure("db.cdc.earliest");
}
...
function query(from, selectors = []) {
    ...
    return new CypherProcedure_1.CypherProcedure("db.cdc.query", [fromExpr, selectorsExpr]);
}
exports.query = query;

 ...
 */
function current() {
    return new CypherProcedure_1.CypherProcedure("cdc.current");
}
 ...
 */
function earliest() {
    return new CypherProcedure_1.CypherProcedure("cdc.earliest");
}
...
function query(from, selectors = []) {
    ...
    return new CypherProcedure_1.CypherProcedure("cdc.query", [fromExpr, selectorsExpr]);
}
exports.query = query;

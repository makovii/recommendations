...
const publish_events_to_subscription_mechanism_1 = require("../../../schema/subscriptions/publish-events-to-subscription-mechanism");
        ...
        switch (cdcEvent.operation) {
            case "c":
                return {
                    ...
                    properties: {
                        old: undefined,
                        new: (0, publish_events_to_subscription_mechanism_1.serializeProperties)(cdcEvent.state.after?.properties) || {},
                    },
            ...
            case "d":
                return {
                    ...
                    typename,
                    properties: {
                        old: (0, publish_events_to_subscription_mechanism_1.serializeProperties)(cdcEvent.state.before?.properties) || {},
                        new: undefined,
                    },
                    id: cdcEvent.elementId,
                    timestamp,

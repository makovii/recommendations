...
class CypherScalarOperation extends operations_1.Operation {
    ...
    transpile(context) {
        ...
        const ret = new cypher_builder_1.default.Return(retProj);
        ...
        const clause = cypher_builder_1.default.concat(matchClause, ret);
        return {
            clauses: [clause],
...
exports.CypherScalarOperation = CypherScalarOperation;
//# sourceMappingURL=CypherScalarOperation.js.map
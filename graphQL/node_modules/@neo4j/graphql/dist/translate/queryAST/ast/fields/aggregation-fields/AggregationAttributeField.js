...
class AggregationAttributeField extends AggregationField_1.AggregationField {
    ...
    getAggregationProjection(target, returnVar) {
        if (this.attribute.typeHelper.isString()) {
            ...
            return cypher_builder_1.default.concat(new cypher_builder_1.default.With(target)
                .orderBy([cypher_builder_1.default.size(aggrProp), "DESC"])
                .with([cypher_builder_1.default.collect(aggrProp), listVar]), projection);
        }
        return new cypher_builder_1.default.Return([this.getAggregationExpr(target), returnVar]);
    }

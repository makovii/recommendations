...
const FulltextScoreSort_1 = require("../ast/sort/FulltextScoreSort");
...
class SortAndPaginationFactory {
    ...
    createPropertySort({ optionArg, entity, context, scoreVariable, }) {
        ...
        return Object.entries(optionArg).map(([fieldName, sortDir]) => {
            ...
            if (fieldName === fulltext_1.SCORE_FIELD && scoreVariable) {
                return new FulltextScoreSort_1.FulltextScoreSort({
                    scoreVariable,
                    direction: sortDir,
                });
            }
